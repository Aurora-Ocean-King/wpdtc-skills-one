...
**Example Commits**:
```bash
git commit -m "feat(wpdtc-cover-image): add watercolor and minimalist styles"
git commit -m "fix(wpdtc-comic): improve panel layout for long dialogues"
...
```
Commits created:
  1. feat(wpdtc-cover-image): add watercolor and minimalist styles
  2. fix(wpdtc-comic): improve panel layout for long dialogues
...
Changes grouped by skill/module:
  wpdtc-cover-image:
    ...
    → Commit: feat(wpdtc-cover-image): add watercolor and minimalist styles
    → README updates: options table

  wpdtc-comic:
    - fix: panel layout for long dialogues
    → Commit: fix(wpdtc-comic): improve panel layout for long dialogues
    → No README updates
