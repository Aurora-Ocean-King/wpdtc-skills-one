...
wpdtc-fetch - Read a URL into Markdown or JSON with Chrome CDP
...
Examples:
  ...
  wpdtc-fetch https://example.com --format json --output article.json
  wpdtc-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for interaction
  wpdtc-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for force
`.trim();
