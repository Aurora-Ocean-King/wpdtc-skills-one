...
metadata:
  openclaw:
    homepage: https://github.com/Aurora-Ocean-King/wpdtc-skills-one#wpdtc-compress-image
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.wpdtc-skills/wpdtc-compress-image/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-compress-image/EXTEND.md` | XDG |
| 3 | `$HOME/.wpdtc-skills/wpdtc-compress-image/EXTEND.md` | User home |
