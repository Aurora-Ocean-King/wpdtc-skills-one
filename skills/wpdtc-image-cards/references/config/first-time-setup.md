...
description: First-time setup flow for wpdtc-xhs-images preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.wpdtc-skills/wpdtc-xhs-images/EXTEND.md` | Current project |
| User | `~/.wpdtc-skills/wpdtc-xhs-images/EXTEND.md` | All projects |
