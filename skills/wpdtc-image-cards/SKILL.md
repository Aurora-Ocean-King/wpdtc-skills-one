...
metadata:
  openclaw:
    homepage: https://github.com/Aurora-Ocean-King/wpdtc-skills-one#wpdtc-image-cards
---
...
| Path | Scope |
|------|-------|
| `.wpdtc-skills/wpdtc-image-cards/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-image-cards/EXTEND.md` | XDG |
| `$HOME/.wpdtc-skills/wpdtc-image-cards/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure wpdtc-image-cards preferences" / "重新配置"). The next run re-triggers first-time setup.
