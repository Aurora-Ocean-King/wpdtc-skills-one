...
description: First-time setup flow for wpdtc-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.wpdtc-skills/wpdtc-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.wpdtc-skills/wpdtc-post-to-wechat/EXTEND.md` | All projects |
