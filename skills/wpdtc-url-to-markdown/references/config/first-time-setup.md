...
description: First-time setup flow for wpdtc-url-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.wpdtc-skills/wpdtc-url-to-markdown/EXTEND.md` | All projects |
| Project | `.wpdtc-skills/wpdtc-url-to-markdown/EXTEND.md` | Current project |
