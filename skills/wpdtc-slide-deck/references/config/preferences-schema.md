...
Structure for user preferences in `.wpdtc-skills/wpdtc-slide-deck/EXTEND.md`.
...
Then use with: `/wpdtc-slide-deck content.md --style style-name`
...
1. `.wpdtc-skills/wpdtc-slide-deck/EXTEND.md` (project)
2. `$HOME/.wpdtc-skills/wpdtc-slide-deck/EXTEND.md` (user)
