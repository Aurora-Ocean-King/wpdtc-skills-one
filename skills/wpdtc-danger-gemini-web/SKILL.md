...
metadata:
  openclaw:
    homepage: https://github.com/Aurora-Ocean-King/wpdtc-skills-one#wpdtc-danger-gemini-web
    requires:
      anyBins:
        - bun
        - npx
...
- macOS: `~/Library/Application Support/wpdtc-skills/gemini-web/consent.json`
- Linux: `~/.local/share/wpdtc-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\wpdtc-skills\gemini-web\consent.json`
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.wpdtc-skills/wpdtc-danger-gemini-web/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-danger-gemini-web/EXTEND.md` | XDG |
| 3 | `$HOME/.wpdtc-skills/wpdtc-danger-gemini-web/EXTEND.md` | User home |
