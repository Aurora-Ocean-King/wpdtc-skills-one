...
```bash
/wpdtc-comic content.md --storyboard-only
```
...
```bash
/wpdtc-comic content.md --prompts-only
```
...
```bash
/wpdtc-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/wpdtc-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/wpdtc-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/wpdtc-comic comic/topic-slug/ --regenerate 0
```
