...
description: First-time setup flow for wpdtc-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.wpdtc-skills/wpdtc-comic/EXTEND.md` | Current project |
| User | `~/.wpdtc-skills/wpdtc-comic/EXTEND.md` | All projects |
