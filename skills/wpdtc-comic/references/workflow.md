...
test -f .wpdtc-skills/wpdtc-comic/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-comic/EXTEND.md" && echo "xdg"
test -f "$HOME/.wpdtc-skills/wpdtc-comic/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .wpdtc-skills/wpdtc-comic/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/wpdtc-skills/wpdtc-comic/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.wpdtc-skills/wpdtc-comic/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.wpdtc-skills/wpdtc-comic/EXTEND.md` | Project directory |
| `$HOME/.wpdtc-skills/wpdtc-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., wpdtc-imagine)
