...
description: First-time setup flow for wpdtc-danger-x-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.wpdtc-skills/wpdtc-danger-x-to-markdown/EXTEND.md` | All projects |
| Project | `.wpdtc-skills/wpdtc-danger-x-to-markdown/EXTEND.md` | Current project |
