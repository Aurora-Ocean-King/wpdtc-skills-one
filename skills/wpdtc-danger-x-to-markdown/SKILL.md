---
name: wpdtc-danger-x-to-markdown
...
metadata:
  openclaw:
    homepage: https://github.com/Aurora-Ocean-King/wpdtc-skills-one#wpdtc-danger-x-to-markdown
    requires:
      anyBins:
        - bun
        - npx
...
```bash
# macOS
cat ~/Library/Application\ Support/wpdtc-skills/x-to-markdown/consent.json

# Linux
cat ~/.local/share/wpdtc-skills/x-to-markdown/consent.json
```
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.wpdtc-skills/wpdtc-danger-x-to-markdown/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-danger-x-to-markdown/EXTEND.md` | XDG |
| 3 | `$HOME/.wpdtc-skills/wpdtc-danger-x-to-markdown/EXTEND.md` | User home |
