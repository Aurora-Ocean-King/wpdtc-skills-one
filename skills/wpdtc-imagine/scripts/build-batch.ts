...
Options:
  ...
  --provider <name>    Provider for wpdtc-imagine batch tasks (default: replicate)
  --model <id>         Explicit model for wpdtc-imagine batch tasks (default: resolved by wpdtc-imagine config/env)
