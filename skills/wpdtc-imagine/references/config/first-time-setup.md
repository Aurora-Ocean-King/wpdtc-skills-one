...
description: First-time setup and default model selection flow for wpdtc-imagine
---
...
options:
  ...
  - label: "Evolink"
    description: "Evolink GPT Image 2 — async, supports gpt-image-2, Nanobanana, Seedream, Z Image Turbo"
```
...
### Question 2f: Default Evolink Model

Only show if user selected Evolink.

```yaml
header: "Evolink Model"
question: "Default Evolink image generation model?"
options:
  - label: "gpt-image-2-beta (Recommended)"
    description: "Latest GPT Image 2 Beta — ratio-based sizes, fast generation"
  - label: "gpt-image-2"
    description: "GPT Image 2 stable — resolution + quality controls, full pixel support"
  - label: "gpt-image-1.5-beta"
    description: "GPT Image 1.5 Lite — simpler, cost-effective"
  - label: "gemini-3.1-flash-image-preview"
    description: "Nanobanana 2 — fast, web_search support, 0.5K-4K"
  - label: "gemini-3-pro-image-preview"
    description: "Nanobanana Pro — highest quality, 1K-4K, web_search"
  - label: "nano-banana-2-beta"
    description: "Nanobanana 2 Beta — experimental, fast"
  - label: "nano-banana-beta"
    description: "Nanobanana v1 — basic, limited ratios"
  - label: "z-image-turbo"
    description: "Z Image Turbo — custom pixel sizes, seed support"
  - label: "seedream-4.5"
    description: "Seedream 4.5 — 2K/4K quality, multi-image output"
```
...
options:
  - label: "Project (Recommended)"
    description: ".wpdtc-skills/ (this project only)"
  - label: "User"
    description: "~/.wpdtc-skills/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.wpdtc-skills/wpdtc-imagine/EXTEND.md` | Current project |
| User | `$HOME/.wpdtc-skills/wpdtc-imagine/EXTEND.md` | All projects |
...
default_model:
  ...
  jimeng: null
  seedream: null
  evolink: [selected evolink model or null]
---
```
...
- In `wpdtc-imagine`, Azure `--model` / `default_model.azure` should be the Azure deployment name, not just the underlying model family.
...
- In `wpdtc-imagine`, `quality` is a compatibility preset. It is not a native DashScope parameter.
...
- In `wpdtc-imagine`, Z.AI currently exposes text-to-image only; reference images are not wired for this provider.
...
options:
  - label: "google/nano-banana-2 (Recommended)"
    description: "Current default for general Replicate image generation in wpdtc-imagine"
...
### Evolink Model Selection

```yaml
header: "Evolink Model"
question: "Choose a default Evolink image generation model?"
options:
  - label: "gpt-image-2-beta (Recommended)"
    description: "Latest GPT Image 2 Beta, ratio-based sizes"
  - label: "gpt-image-2"
    description: "GPT Image 2 stable — full resolution + quality controls"
  - label: "gemini-3.1-flash-image-preview"
    description: "Nanobanana 2 — fast, 0.5K-4K, web_search"
  - label: "gemini-3-pro-image-preview"
    description: "Nanobanana Pro — highest quality, 1K-4K"
```
