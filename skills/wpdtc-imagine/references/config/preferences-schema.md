...
description: EXTEND.md YAML schema for wpdtc-imagine user preferences
---
...
default_provider: null      # google|openai|azure|openrouter|dashscope|zai|minimax|replicate|jimeng|seedream|evolink|null (null = auto-detect)
...
default_model:
  ...
  jimeng: null              # e.g., "jimeng_t2i_v40"
  seedream: null            # e.g., "doubao-seedream-5-0-260128"
  evolink: null             # e.g., "gpt-image-2-beta"
...
| `default_model.jimeng` | string\|null | null | Jimeng default model |
| `default_model.seedream` | string\|null | null | Seedream default model |
| `default_model.evolink` | string\|null | null | Evolink default model |
