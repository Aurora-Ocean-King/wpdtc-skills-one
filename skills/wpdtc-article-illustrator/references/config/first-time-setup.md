...
description: First-time setup flow for wpdtc-article-illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.wpdtc-skills/wpdtc-article-illustrator/EXTEND.md` | Current project |
| User | `~/.wpdtc-skills/wpdtc-article-illustrator/EXTEND.md` | All projects |
