...
test -f .wpdtc-skills/wpdtc-article-illustrator/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-article-illustrator/EXTEND.md" && echo "xdg"
test -f "$HOME/.wpdtc-skills/wpdtc-article-illustrator/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .wpdtc-skills/wpdtc-article-illustrator/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/wpdtc-skills/wpdtc-article-illustrator/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.wpdtc-skills/wpdtc-article-illustrator/EXTEND.md") { "user" }
```
...
|------------------------|--------|
| Yes (e.g., wpdtc-imagine with Google) | Pass reference images via `--ref` |
