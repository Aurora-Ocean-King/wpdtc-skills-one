---
name: wpdtc-article-illustrator
...
metadata:
  openclaw:
    homepage: https://github.com/Aurora-Ocean-King/wpdtc-skills-one#wpdtc-article-illustrator
---
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.wpdtc-skills/wpdtc-article-illustrator/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-article-illustrator/EXTEND.md` | XDG |
| 3 | `$HOME/.wpdtc-skills/wpdtc-article-illustrator/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure wpdtc-article-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
