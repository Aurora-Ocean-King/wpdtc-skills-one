...
description: First-time setup flow for wpdtc-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.wpdtc-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.wpdtc-skills/wpdtc-translate/EXTEND.md` | All projects |
| Project | `.wpdtc-skills/wpdtc-translate/EXTEND.md` | Current project |
