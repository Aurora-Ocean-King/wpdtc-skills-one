...
metadata:
  openclaw:
    homepage: https://github.com/Aurora-Ocean-King/wpdtc-skills-one#wpdtc-cover-image
---
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.wpdtc-skills/wpdtc-cover-image/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/wpdtc-skills/wpdtc-cover-image/EXTEND.md` | XDG |
| 3 | `$HOME/.wpdtc-skills/wpdtc-cover-image/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure wpdtc-cover-image preferences" / "重新配置"). The next run re-triggers first-time setup.
