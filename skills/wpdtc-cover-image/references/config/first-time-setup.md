...
description: First-time setup flow for wpdtc-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.wpdtc-skills/wpdtc-cover-image/EXTEND.md` | Current project |
| User | `~/.wpdtc-skills/wpdtc-cover-image/EXTEND.md` | All projects |
